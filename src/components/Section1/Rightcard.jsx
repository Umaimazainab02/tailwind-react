...
const Rightcard = () => {
    return (
        <div className=" w-70 h-full relative overflow-hidden rounded-3xl">
            ...
            <div className="absolute bottom-0 left-0 right-0 h-full  p-6 flex justify-between flex-col">
                <div className="text-5xl font-bold text-black bg-white h-10 w-10 rounded-full flex items-center justify-center text-xl">
                    1
                </div>
                <div>
                    <h3 className='text-white pr-23'>Prime customers that have access to bank credit and are satisfied with the current products.</h3>
